# ARCHIVED 2026-04-07. See v2 at ../rhythm.py
# Why: _markov_chain() consumed mode strings (focused/distributed/diffuse) from
# snap.attention.mode, building transition matrices over human categories.
# Replaced with _bin_centroids() — bins spectral_centroid into 4 regions
# (low/mid_low/mid_high/high) as bins on a measurable axis, not human labels.
