...
def candidate_brief(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "release_causal_divergence": metrics.get("release_causal_divergence"),
        "release_gain_zero_release_causal_divergence": metrics.get("release_gain_zero_release_causal_divergence"),
        "release_timing_score": metrics.get("release_timing_score"),
